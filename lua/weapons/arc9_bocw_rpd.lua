...
SWEP.Description = [[Full-auto light machine gun. Reliable stopping power with superior handling and movement speeds.
...
SWEP.ViewModel = "models/weapons/arc9/c_arc9_rpd_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_rpd_bocw.mdl"
...
SWEP.RangeMin = 25.4 * 39.37 -- How far bullets retain their maximum damage for.
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_rpd_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
if SprintMultCvar:GetBool() then
    SWEP.SpeedMultSprint = 0.6671539961013645 -- SPRINT SPEED RELATIVE TO MOVE SPEED
else
...
SWEP.ShootSound = "ARC9_BOCW.RPD_fire"
--SWEP.ShootSoundIndoor = "ARC9_BOCW.RPD_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.RPD_fire_silenced"                    -- Fire silenced
...
SWEP.BulletBones = { -- the bone that represents bullets in gun/mag
    ...
    "tag_bullet_deplete_sqtl_13_animate"
}
SWEP.CaseBones = {}
...
SWEP.CustomizeRotateAnchor = Vector(11, 0, -4)
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Category = {"bocw_rpd_barrel"},
        InstalledElements = {"barrelgone"},
    },
    {
        PrintName = "BODY",
        Bone = "tag_barrel",
        Pos = Vector(0.5, 1.445, 0.776),
        Ang = Angle(0, 0, -45),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_lmg_body_lasereast", "bocw_lmg_body_flasheast"},
    ...
    },
    {
        ...
        Ang = Angle(0, 0, -30),
        Category = {"bocw_lmg_body_mixeast"},
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_rpd_sticker1.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 2",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_rpd_sticker2.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 3",
    ...
    },
    {
        PrintName = "STICKER 4",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_rpd_sticker4.mdl",
        CosmeticOnly = true,
    },
}
--=========================================================
...
local CustomSlotTable = {
    ...
    Category = {"bocw_custom_slot", "bocw_custom_slot_rpd"},
}
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["rpd_mag_ext"] then
        return anim .. "_ext"
    end

    if elements["rpd_mag_fast"] then
        return anim .. "_fast"
    end
