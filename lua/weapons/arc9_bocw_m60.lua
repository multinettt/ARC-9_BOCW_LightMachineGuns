...
SWEP.Trivia = {
    ...
    Mechanism = "Gas-operated short stroke piston opened rotating bolt",
    Country = "USA",
    Year = 1957
}
...
SWEP.Description = [[Full-auto light machine gun. Consistent ammo capacity with heavy-grain rounds provides premium stopping power and bullet economy. Slower fire rate and handling speeds.
...
The M60 returns in Call of Duty: Black Ops Cold War.]]
...
SWEP.RangeMax = 75 * 39.37 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.PhysBulletMuzzleVelocity = 791 * 39.37
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_m60_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "ARC9_BOCW.M60_fire"
...
SWEP.CustomizePos = Vector(17, 42, 5)
...
SWEP.Attachments = {
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_m60_sticker1.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 2",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_m60_sticker2.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 3",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_m60_sticker3.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 4",
...
local CustomSlotTable = {
    ...
    Category = {"bocw_custom_slot", "bocw_custom_slot_m60"},
}
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.M60_boltforward", t = 0.9 },
            { s = "ARC9_BOCW.M60_reload_end", t = 1.5 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["enter_inspect"] = {
        ...
        --Time = 4.5,
        EventTable = {
            { s = "ARC9_BOCW.M60_inspect_part1", t = 0 },
            { s = "ARC9_BOCW.M60_inspect_part2", t = 5 },
        },
        IKTimeLine = {
            {
                t = 0,
